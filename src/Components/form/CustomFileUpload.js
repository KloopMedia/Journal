			...
			{props.disabled ? null :
				<div>
					...
					{connectingTelegram ?
						...
						:
						telegramConnected ?
							<div>Вы можете начать загрузку файлов через бота. Все файлы, отправляемые боту, будут сохраняться здесь. После загрузки файлов через бот, не забудьте  Перейти в бот.</div>
							:
							<div>
